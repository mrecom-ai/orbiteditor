...
import '../platform/browserView/electron-sandbox/browserViewService.contribution.js';
...
// Browser View (integrated native browser editor)
import './contrib/browserView/electron-sandbox/browserView.contribution.js';
