...
Orbit separately records basic usage like the number of messages people are sending. If you'd like to disable Orbit metrics, you may do so in Orbit's Settings.
`;
