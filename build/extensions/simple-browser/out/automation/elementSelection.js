...
exports.buildHoverScript = buildHoverScript;
const buildPickScript = (x, y) => {
    const p = sanitizePoint(x, y);
    return `(() => {
...
exports.buildPickScript = buildPickScript;
